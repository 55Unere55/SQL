...
species_class INT NOT NULL CONSTRAINT fk_class_id FOREIGN KEY REFERENCES tbl_class_id(class_id) ON UPDATE CASCADE ON DELETE CASCADE,
species_order INT NOT NULL CONSTRAINT fk_order_id FOREIGN KEY REFERENCES tbl_order_id(order_id) ON UPDATE CASCADE ON DELETE CASCADE,
species_habitat INT NOT NULL CONSTRAINT fk_habitat_id FOREIGN KEY REFERENCES tbl_habitat_id(habitat_id) ON UPDATE CASCADE ON DELETE CASCADE,
species_nutrition INT NOT NULL CONSTRAINT fk_nutrition FOREIGN KEY REFERENCES tbl_nutrition_id(nutrition_id) ON UPDATE CASCADE ON DELETE CASCADE,
species_care VARCHAR(50) NOT NULL CONSTRAINT fk_care_id FOREIGN KEY REFERENCES tbl_care_id(care_id) ON UPDATE CASCADE ON DELETE CASCADE,
);
...
('cliff with shadowed cave', 15000)
;
...
SELECT * FROM tbl-species WHERE species_name = 'chicken';
...
a1.species_name, a2.animalia_type, a3.class_type, a4.order_type, a5.habitat_type, a6.nutrition_type, a7.care_type,
FROM tbl_species a1
INNER JOIN tbl_habitat a2 ON a2.habitat_id = a1.species.habitat
